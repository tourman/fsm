    ...
    public function provideLogsWithActionReasonWithEmptySymbol()
    {
        ...
        return array(
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',     'reason' => 'init',   'symbol' => null, 'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT', 'reason' => 'action', 'symbol' => null, 'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT', 'reason' => 'sleep',  'symbol' => null, 'timestamp' => '1.000002'),
                ),
                'logRecordIndex' => 1,
            ),
    ...
    public function provideLogsWithActionReasonWithAbsentSymbol()
    {
        ...
        return array(
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,       'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'action', 'symbol' => 'failed',   'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000002'),
                ),
                'logRecordIndex' => 1,
            ),
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,       'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'action', 'symbol' => 'checkout', 'timestamp' => '1.000001'),
                    array('state' => 'PROCESSING', 'reason' => 'action', 'symbol' => 'checkout', 'timestamp' => '1.000001'),
                    array('state' => 'PROCESSING', 'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000002'),
                ),
                'logRecordIndex' => 2,
            ),
        );
    ...
    public function provideLogsWithActionReasonWithMismatchSymbol()
    {
        ...
        return array(
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,       'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'action', 'symbol' => '*',        'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000002'),
                ),
                'logRecordIndex' => 1,
            ),
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,       'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'action', 'symbol' => 'checkout', 'timestamp' => '1.000001'),
                    array('state' => 'PROCESSING', 'reason' => 'action', 'symbol' => 'failed',   'timestamp' => '1.000001'),
                    array('state' => 'PROCESSING', 'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000002'),
                ),
                'logRecordIndex' => 2,
            ),
    ...
    public function provideLogsWithSleepReasonWithNotEmptySymbol()
    {
        ...
        return array(
            array(
                ...
                'log' => array(
                    array('state' => 'INIT', 'reason' => 'init',  'symbol' => null, 'timestamp' => '1.000001'),
                    array('state' => 'INIT', 'reason' => 'sleep', 'symbol' => '*',  'timestamp' => '1.000002'),
                ),
                'logRecordIndex' => 1,
            ),
        );
        ...
        return array(
            array(
                ...
                'log' => array(
                    array('state' => 'INIT', 'reason' => 'init',   'symbol' => null, 'timestamp' => '1.000001'),
                    array('state' => 'INIT', 'reason' => 'sleep',  'symbol' => null, 'timestamp' => '1.000002'),
                    array('state' => 'INIT', 'reason' => 'wakeup', 'symbol' => '*',  'timestamp' => '1.000002'),
                    array('state' => 'INIT', 'reason' => 'sleep',  'symbol' => null, 'timestamp' => '1.000002'),
                ),
                'logRecordIndex' => 2,
            ),
