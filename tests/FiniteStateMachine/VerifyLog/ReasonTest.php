 ...
 * public function test_VerifyLog_Reason_TheLastPosition_NotSleep_ThrowsException_CertainKeys
...
class Fsm_VerifyLog_ReasonTest extends Fsm_VerifyLogTestCase
{
    ...
    public function provideLogsWithNotInitFirstPosition()
    {
        ...
        return array(
            array(
                'stateSet' => $stateSet,
                'log' => array(
                    array('state' => 'INIT',     'reason' => 'action', 'symbol' => null,       'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT', 'reason' => 'action', 'symbol' => 'checkout', 'timestamp' => '1.000002'),
                    array('state' => 'CHECKOUT', 'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000003'),
                ),
                'logRecordIndex' => 0,
                'extra' => 'action',
            ),
            array(
                'stateSet' => $stateSet,
                'log' => array(
                    array('state' => 'INIT',     'reason' => 'reset',  'symbol' => null,       'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT', 'reason' => 'action', 'symbol' => 'checkout', 'timestamp' => '1.000002'),
                    array('state' => 'CHECKOUT', 'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000003'),
                ),
                'logRecordIndex' => 0,
            ...
            array(
                'stateSet' => $stateSet,
                'log' => array(
                    array('state' => 'INIT',     'reason' => 'wakeup', 'symbol' => null,       'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT', 'reason' => 'action', 'symbol' => 'checkout', 'timestamp' => '1.000002'),
                    array('state' => 'CHECKOUT', 'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000003'),
                ),
                'logRecordIndex' => 0,
            ...
            array(
                'stateSet' => $stateSet,
                'log' => array(
                    array('state' => 'INIT',     'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT', 'reason' => 'action', 'symbol' => 'checkout', 'timestamp' => '1.000002'),
                    array('state' => 'CHECKOUT', 'reason' => 'sleep',  'symbol' => null,       'timestamp' => '1.000003'),
                ),
                'logRecordIndex' => 0,
     ...
     * @dataProvider provideLogsWithNotSleepLastPosition
     */
    public function test_VerifyLog_Reason_TheLastPosition_NotSleep_ThrowsException_CertainKeys($stateSet, $log, $logRecordIndex)
    {
        $this->assertExceptionMessage($stateSet, $log, 'index', $logRecordIndex);
    }
        ...
        return array(
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,         'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'action', 'symbol' => 'checkout',   'timestamp' => '1.000002'),
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,         'timestamp' => '1.000003'),
                    array('state' => 'INIT',       'reason' => 'sleep',  'symbol' => null,         'timestamp' => '1.000004'),
                ),
                'logRecordIndex' => 2,
            ),
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,         'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'init',   'symbol' => 'checkout',   'timestamp' => '1.000002'),
                    array('state' => 'PROCESSING', 'reason' => 'action', 'symbol' => 'processing', 'timestamp' => '1.000003'),
                    array('state' => 'PROCESSING', 'reason' => 'sleep',  'symbol' => null,         'timestamp' => '1.000004'),
                ),
                'logRecordIndex' => 1,
            ),
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,         'timestamp' => '1.000001'),
                    array('state' => 'CHECKOUT',   'reason' => 'init',   'symbol' => 'checkout',   'timestamp' => '1.000002'),
                    array('state' => 'PROCESSING', 'reason' => 'init',   'symbol' => 'processing', 'timestamp' => '1.000003'),
                    array('state' => 'PROCESSING', 'reason' => 'sleep',  'symbol' => null,         'timestamp' => '1.000004'),
                ),
                'logRecordIndex' => 1,
            ),
     ...
     * @dataProvider provideLogsWithInitNotAtFirstPosition
     */
    public function test_VerifyLog_Reason_Init_NotAtTheFirstPosition_ThrowsException_CertainKeys($stateSet, $log, $logRecordIndex)
    {
        $this->assertExceptionMessage($stateSet, $log, 'index', $logRecordIndex);
    }
        ...
        return array(
            array(
                ...
                'log' => array(
                    ...
                    array('state' => 'PROCESSING', 'reason' => 'action', 'symbol' => 'processing', 'timestamp' => '1.000003'),
                    array('state' => 'PROCESSING', 'reason' => 'sleep',  'symbol' => null,         'timestamp' => '1.000004'),
                    array('state' => 'PENDING',    'reason' => 'action', 'symbol' => 'pending',    'timestamp' => '1.000005'),
                    array('state' => 'CHECKOUT',   'reason' => 'wakeup', 'symbol' => null,         'timestamp' => '1.000006'),
                    array('state' => 'PENDING',    'reason' => 'sleep',  'symbol' => null,         'timestamp' => '1.000007'),
                ),
                'logRecordIndex' => 4,
            ),
        );
