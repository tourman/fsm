    ...
    public function provideLogsWithInvalidTypeState()
    {
        ...
        return array(
            array(
                'stateSet' => $stateSet,
                'log' => array(
                    array('state' => 1,              'reason' => 'init',  'symbol' => null, 'timestamp' => '1.000009'),
            ...
            array(
                ...
                'log' => array(
                    ...
                    array('state' => 1.1,            'reason' => 'sleep', 'symbol' => null, 'timestamp' => '1.000009'),
                ),
                'logRecordIndex' => 1,
            ),
            array(
                'stateSet' => $stateSet,
                'log' => array(
                    array('state' => array(),        'reason' => 'init',  'symbol' => null, 'timestamp' => '1.000009'),
                    array('state' => 'INIT',         'reason' => 'sleep', 'symbol' => null, 'timestamp' => '1.000009'),
                ),
                'logRecordIndex' => 0,
            ),
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',         'reason' => 'init',  'symbol' => null, 'timestamp' => '1.000009'),
                    array('state' => new stdClass(), 'reason' => 'sleep', 'symbol' => null, 'timestamp' => '1.000009'),
                ),
                'logRecordIndex' => 1,
            ),
            array(
                'stateSet' => $stateSet,
                'log' => array(
                    array('state' => null,           'reason' => 'init',  'symbol' => null, 'timestamp' => '1.000009'),
                    array('state' => 'INIT',         'reason' => 'sleep', 'symbol' => null, 'timestamp' => '1.000009'),
                ),
                'logRecordIndex' => 0,
            ),
    ...
    public function provideLogsWithResetReasonWithNotInitState()
    {
        ...
        return array(
            array(
                'stateSet' => $stateSet,
                'log' => array(
                    array('state' => 'INIT',     'reason' => 'init',   'symbol' => null,       'timestamp' => '147.800800'),
                    array('state' => 'CHECKOUT', 'reason' => 'action', 'symbol' => 'checkout', 'timestamp' => '147.800801'),
                    array('state' => 'CHECKOUT', 'reason' => 'reset',  'symbol' => null,       'timestamp' => '147.800802'),
                    array('state' => 'CHECKOUT', 'reason' => 'sleep',  'symbol' => null,       'timestamp' => '148.800800'),
                ),
                'logRecordIndex' => 2,
            ),
        );
        ...
        return array(
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,         'timestamp' => '147.800800'),
                    array('state' => 'CHECKOUT',   'reason' => 'action', 'symbol' => 'checkout',   'timestamp' => '147.800801'),
                    array('state' => 'PENDING',    'reason' => 'action', 'symbol' => 'processing', 'timestamp' => '147.800802'),
                    array('state' => 'PENDING',    'reason' => 'sleep',  'symbol' => null,         'timestamp' => '148.800800'),
                ),
                'logRecordIndex' => 2,
            ),
            array(
                ...
                'log' => array(
                    array('state' => 'INIT',       'reason' => 'init',   'symbol' => null,         'timestamp' => '147.800800'),
                    array('state' => 'CHECKOUT',   'reason' => 'action', 'symbol' => 'checkout',   'timestamp' => '147.800801'),
                    array('state' => 'PROCESSING', 'reason' => 'action', 'symbol' => 'processing', 'timestamp' => '147.800802'),
                    array('state' => 'INIT',       'reason' => 'action', 'symbol' => 'pending',    'timestamp' => '147.800802'),
                    array('state' => 'INIT',       'reason' => 'sleep',  'symbol' => null,         'timestamp' => '148.800800'),
                ),
                'logRecordIndex' => 3,
            ),
        );
        ...
        return array(
            ...
            array(
                ...
                'log' => array(
                    ...
                    array('state' => 'CHECKOUT',   'reason' => 'action', 'symbol' => 'checkout',   'timestamp' => '147.800801'),
                    array('state' => 'PROCESSING', 'reason' => 'action', 'symbol' => 'processing', 'timestamp' => '147.800802'),
                    array('state' => 'CHECKOUT',   'reason' => 'sleep',  'symbol' => null,         'timestamp' => '147.800802'),
                    array('state' => 'CHECKOUT',   'reason' => 'wakeup', 'symbol' => null,         'timestamp' => '147.800802'),
                    array('state' => 'PROCESSING', 'reason' => 'action', 'symbol' => 'processing', 'timestamp' => '147.800802'),
                    array('state' => 'PROCESSING', 'reason' => 'sleep',  'symbol' => null,         'timestamp' => '148.800800'),
                ),
                'logRecordIndex' => 3,
            ),
        );
        ...
        return array(
            array(
                ...
                'log' => array(
                    ...
                    array('state' => 'PROCESSING', 'reason' => 'action', 'symbol' => 'processing', 'timestamp' => '147.800802'),
                    array('state' => 'PROCESSING', 'reason' => 'sleep',  'symbol' => null,         'timestamp' => '148.800800'),
                    array('state' => 'CHECKOUT',   'reason' => 'wakeup', 'symbol' => null,         'timestamp' => '148.800801'),
                    array('state' => 'CHECKOUT',   'reason' => 'sleep',  'symbol' => null,         'timestamp' => '148.800801'),
                ),
                'logRecordIndex' => 4,
            ),
        );
